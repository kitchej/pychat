"""
Provided by crxguy52 https://stackoverflow.com/questions/3221956/how-do-i-display-tooltips-in-tkinter
...
Customized by Joshua Kitchen - 2025
"""
...
class CreateToolTip(object):
    ...
    """
    def __init__(self, widget, text='widget info', widget_background_color='#ffffff'):
        self.widget_background_color = widget_background_color
        self.button_highlight_color = "#bfbfbf"
    ...
    def enter(self, event=None):
        self.widget['background'] = self.button_highlight_color
        self.schedule()

    def leave(self, event=None):
        self.widget['background'] = self.widget_background_color
        self.unschedule()
        self.hidetip()
